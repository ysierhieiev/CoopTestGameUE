...
void ASCharacter::MoveForward(float Variable)
{
	AddMovementInput(GetActorForwardVector()* Variable);
}

void ASCharacter::MoveRight(float Variable)
{
	AddMovementInput(GetActorRightVector() * Variable);
